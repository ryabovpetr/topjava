...
import static ru.javawebinar.topjava.web.meal.AbstractMealController.DUPLICATE_DATE_TIME_ERROR;
import static ru.javawebinar.topjava.web.user.AbstractUserController.DUPLICATE_EMAIL_ERROR;
...
//        }
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)  // 409
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, details.length == 0 ? new String[] {rootCause.toString()} : details);
    }
}